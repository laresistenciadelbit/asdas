...
$( document ).ready(function() {
    var stations=Object.keys(_.chain(station_data).groupBy('station').value()).length;
});
        ...
        <div class="row">
          ...
          <section class="col-lg-5 connectedSortable">
			...
			//https://wiki.openstreetmap.org/wiki/Deploying_your_own_Slippy_Map
				...
				if($use_map)
				{
					echo '<div id="map_osm" style="height:300px;"></div>';
					echo '<script> var mymap = L.map("map_osm").setView([51.505, -0.09], 13); </script>';
